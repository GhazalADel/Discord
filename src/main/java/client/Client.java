...
//    }
     ...
     * *@throws ClassNotFoundException
     */
    public int signUp() throws IOException, ClassNotFoundException {
        int signUpReturn = 0;
        //1--> done
        //-1--> back to main menu
        //0--> keep going
        String username = "";
        while (signUpReturn == 0) {
            ...
            if (username.length() >= 6) {
                ...
                if (numberAndLetter == false) {
                    System.out.println("username should have numbers and letters only...try again\n\n");
                    continue;
                } else {
                    ...
                    if (isDuplicate) {
                        System.out.println("we have an account with this username...try again\n\n");
                        continue;
                    } else {
                        signUpReturn = 1;
                    }
                ...
                System.out.println("Username should hava at least 6 characters...try again\n\n");
                continue;
            }
        }
        signUpReturn = 0;
        ...
        while (signUpReturn == 0) {
            ...
            if (password.length() < 8) {
                ...
                if (!flag) {
                    System.out.println("password should have numbers and letters only...try again\n\n");
                    continue;
                }
                if (!haveLetter) {
                    System.out.println("password should have letter...try again\n\n");
                    continue;
                }
                if (!haveNumber) {
                    System.out.println("password should have number...try again\n\n");
                    continue;
                }
                signUpReturn = 1;
            }
        ...
        while (signUpReturn == 0) {
            ...
            if (!emailIsValid) {
                System.out.println("Invalid input email..try again\n\n");
                continue;
            }
            signUpReturn = 1;
        }
        ...
        while (signUpReturn == 0) {
            ...
            System.out.println("you can skip this part");
            ...
            if (tel.equals("")) {
                ...
                if (tel.length() == 11) {
                    if (!tel.startsWith("09")) {
                        System.out.println("Invalid input tel format...try again\n\n");
                        continue;
                    } else {
                        signUpReturn = 1;
                    }
        ...
        if (signUpReturn == 1) {
            ...
            objectOutputStream.writeObject(request);
            System.out.println(username + " , welcome to discord!\n\n");
        }
        return signUpReturn;
    }
